...
EPOCHS = 50
LR = 0.01
MODEL_PATH = 'model_cnn_mlp_manual_copy.pkl'
...
if os.path.exists(MODEL_PATH):
    ...
    X_extra_mean = model_data['extra_mean']
    X_extra_std = model_data['extra_std']
    ...
    with open(MODEL_PATH, 'wb') as f:
        ...
        'b_out': b_out,
        'label_encoder': le,
        'extra_mean': X_extra.mean(axis=0),
        'extra_std': X_extra.std(axis=0),
        'max_len': max_len
        },f)
